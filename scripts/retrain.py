...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      type=str,
      default='',
      help='Path to training folder holding model and label file.'
  )
  parser.add_argument(
      '--image_dir',
      type=str,
  ...
  FLAGS.output_graph = os.path.join(FLAGS.train_dir, "output_graph.pb")
  FLAGS.output_labels = os.path.join(FLAGS.train_dir, "output_labels.txt")
